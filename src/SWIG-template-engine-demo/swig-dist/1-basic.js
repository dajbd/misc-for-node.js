...
(function () {
  ...
  if (!__l) { return; }
    var _ctx__loopcache037687067524529994 = { loop: _ctx.loop, author: _ctx.author, __k: _ctx.__k };
...
_output += "</li>\n	";
  ...
  _ctx.loop = _ctx__loopcache037687067524529994.loop;
  _ctx.author = _ctx__loopcache037687067524529994.author;
  _ctx.__k = _ctx__loopcache037687067524529994.__k;
  _ctx__loopcache037687067524529994 = undefined;
})();
_output += "\n	</ul>\n	\n	\n</body>\n</html>\n";
